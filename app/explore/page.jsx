...
export default function Explore() {
  ...
  if (authLoading || !dbUser) {
    return (
      <div style={{ position: 'fixed', inset: 0, display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', background: '#0B0B0B', gap: '16px' }}>
        ...
        <p style={{ color: '#D4AF37', fontSize: '14px', fontWeight: 600 }}>Loading…</p>
